...
function Authentication() {
  ...
  const handleClick = () => {
    ...
    <Container>
      ...
      <div style={{ margin: "20% auto", width: "20rem" }}>
      <Form.Control
        type="text"
        value={username}
        onChange={(e) => setUsername(e.target.value)}
        placeholder="        Username" 
        style={{marginTop:"20%",width:"20rem",height:"2.8rem",marginBottom:"0.5rem",borderColor:"#FFFFFF",borderRadius:"1.5rem",fontFamily:"Lato",fontWeight:"bold"}}
      />
      ...
      <Form.Control
        ...
        style ={{ width:"20rem",height:"2.8rem",borderRadius:"1.5rem",borderColor:"#FFFFFF",fontFamily:"Lato",fontWeight:"bold"}}
      />
      ...
      {errorMessage && <p style ={{fontSize:"0.9rem"}}>{errorMessage}</p>}
      </div>
      </Card.Body>
    </Card>
    </Container>
